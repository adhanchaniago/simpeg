		...
		<div class="row">
			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading">Edit Berkas Jabatan Struktural</div>
						...
						<a href="<?php echo base_url("naik_pangkat/detail_pegawai");?>" class="btn btn-success btn-md">KEMBALI</a>
							...
							<form action="" method="post" enctype="multipart/form-data">
								...
								<div class="form-group row">
									...
									<div class="col-xs-10" style="padding-left:15px;">
										<input value="<?=$r->sk_tugas_belajar?>" class="form-control" id="uploadFile5" placeholder="Bagi PNS yang menyelesaikan pendidikan tugas belajar atau ijin belajar" readonly />
								...
								<div class="form-group row">
									...
									<div class="col-xs-10" style="padding-left:15px;">
										<input value="<?=$r->fc_pengembalian_kampus?>" class="form-control" id="uploadFile6" placeholder="Bagi PNS tugas belajar" readonly />
								...
								<div class="form-group row">
									...
									<div class="col-xs-10" style="padding-left:15px;">
										<input value="<?=$r->fc_ijazah?>" class="form-control" id="uploadFile7" placeholder="Fotokopi Sah IJAZAH" readonly />
								...
								<div class="form-group row">
									...
									<div class="col-xs-10" style="padding-left:15px;">
										<input value="<?=$r->fc_transkrip?>" class="form-control" id="uploadFile8" placeholder="Fotokopi Sah TRANSKRIP NILAI" readonly />
								...
								<div class="form-group row">
									...
									<div class="col-xs-10" style="padding-left:15px;">
										<input value="<?=$r->fc_tmpt_kembali?>" class="form-control" id="uploadFile9" placeholder="Fotokopi Sah PENEMPATAN KEMBALI SETELAH TUGAS BELAJAR" readonly />
								...
								<div class="form-group row">
									...
									<div class="col-xs-10" style="padding-left:15px;">
										<input value="<?=$r->fc_sk_jab_struktural?>" class="form-control" id="uploadFile10" placeholder="Fotokopi Sah SK JABATAN STRUKTURAL DAN LAMPIRANNYA" readonly />
										<input value="<?=$r->fc_sk_jab_struktural?>"  name="fc_sk_jab_struktural_hid" type="hidden" readonly />
									</div>
									<div class="col-xs-2" style="padding-right:15px;padding-left:0;">
								...
								<div class="form-group row">
									...
									<div class="col-xs-10" style="padding-left:15px;">
										<input value="<?=$r->fc_naskah_pelantikan?>" class="form-control" id="uploadFile11" placeholder="Fotokopi Sah NASKAH PELANTIKAN" readonly />
										<input value="<?=$r->fc_naskah_pelantikan?>"  name="fc_naskah_pelantikan_hid" type="hidden" readonly />
									</div>
									<div class="col-xs-2" style="padding-right:15px;padding-left:0;">
								...
								<div class="form-group row">
									...
									<div class="col-xs-10" style="padding-left:15px;">
										<input value="<?=$r->fc_sp_pelantikan?>" class="form-control" id="uploadFile12" placeholder="Fotokopi Sah SURAT PERNYATAAN PELANTIKAN" readonly />
										<input value="<?=$r->fc_sp_pelantikan?>"  name="fc_sp_pelantikan_hid" type="hidden" readonly />
									</div>
									<div class="col-xs-2" style="padding-right:15px;padding-left:0;">
								...
								<div class="form-group row">
									...
									<div class="col-xs-10" style="padding-left:15px;">
										<input value="<?=$r->spmj?>" class="form-control" id="uploadFile13" placeholder="Sesuai periode kenaikan pangkat" readonly />
										<input value="<?=$r->spmj?>"  name="spmj_hid" type="hidden" readonly />
									</div>
									<div class="col-xs-2" style="padding-right:15px;padding-left:0;">
								...
								<div class="form-group row">
									...
									<div class="col-xs-10" style="padding-left:15px;">
										<input value="<?=$r->skp?>" class="form-control" id="uploadFile14" placeholder="ASLI SKP TAHUN SEBELUM PENGANGKATAN" readonly />
								...
								<div class="form-group row">
									...
									<div class="col-xs-10" style="padding-left:15px;">
										<input value="<?=$r->sk_pangkat_atasan_langsung?>" class="form-control" id="uploadFile15" placeholder="ASLI SK PANGKAT ATASAN LANGSUNG" readonly />
								...
								<div class="form-group row">
									...
									<div class="col-xs-10" style="padding-left:15px;">
										<input value="<?=$r->cv?>" class="form-control" id="uploadFile16" placeholder="ASLI DAFTAR RIWAYAT HIDUP / PEKERJAAN" readonly />
