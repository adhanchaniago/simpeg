		...
		<div class="row">
			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading">Ubah Password Pegawai</div>
					...
					<?php } ?>
						...
						<form action="<?php echo base_url();?>auth/proses_pegawai" method="post" enctype="multipart/form-data">
								<input value="<?php echo $r->id ?>" name="id" type="hidden"  >
								<div class="form-group">
									<label>NIP</label>
									<input readonly value="<?php echo $r->nip ?>" name="nip" type="text" class="form-control" >
								</div>
